...
### 1. Download the ZIP  
<img src="image-1.png" alt="Download ZIP" width="900"><br>
Click the green **"Code"** button and choose **"Download ZIP"**.

### 2. Extract the ZIP  
<img src="image-2.png" alt="Extract ZIP" width="200"><br>
Right-click the ZIP file and select **"Extract All"**.

### 3. Open Project in Android Studio  
<img src="image-3.png" alt="Open Project" width="200"><br>
Launch Android Studio and go to **File → Open...**

<img src="image-4.png" alt="Select android" width="260"><br>
...
<img src="image-5.png" alt="Create Device" width="300"><br>
In the right toolbar, click **"Device Manager"**.

<img src="image-6.png" alt="Select Phone" width="400"><br>
Click the **+** icon and choose **"Create Virtual Device"**.

<img src="image-7.png" alt="Select API" width="800"><br>
Choose a medium-sized phone, then click **Next**.

<img src="image-8.png" alt="Configure Device" width="800"><br>
Choose **Tiramisu API 33**, then click **Next**.



<img src="image-9.png" alt="Sync Project" width="800"><br>
Fill in the configuration like shown in the image, then click **Finish**.

### 5. Sync and Run  

<img src="image-10.png" alt="" width="300"><br>
Click the **elephant icon** to sync the project with Gradle files.

<img src="image-11.png" alt="Select Device" width="1000"><br>
At the top center, select the virtual device (e.g. **"Medium Phone API 33"**).

<img src="image-12.png" alt="Run App" width="1000"><br>
Click the **Play** button to run the app.


### 6. Allow Permissions

<img src="image-13.png" alt="App List" width="300"><br>
Tap **Cognitive Exercise App** from the list.
<br><br><br>
<img src="image-14.png" alt="Usage Access" width="300"><br>
Enable **Usage Access**.
<br><br><br>
<img src="image-15.png" alt="Back Twice" width="300"><br>
Press the **back button twice** to return.
<br><br><br>
<img src="image-16.png" alt="Select App Again" width="300"><br>
Tap **Cognitive Exercise App** again.
<br><br><br>
<img src="image-17.png" alt="Display Over Other Apps" width="300"><br>
Enable **Display over other apps**.
<br><br><br>
<img src="image-18.png" alt="Back Once" width="300"><br>
Press **back** once to return to the app.
<br>
### 7. Done

<img src="image-19.png" alt="App Ready" width="300"><br>
